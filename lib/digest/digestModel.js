 ...
 * (actionModel.isCritical), not the stored snapshot. Raw risk flags and pushed
 * items never email; they stay in app. isDigestAction is that rule, in one
 * place, reusing the log's own criticality so the two can never disagree.
 *
