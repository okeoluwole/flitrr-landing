...
// The app's one display format, "30 Apr 2028" (dateFormat.js). This module spelled
// the month in full, one of the two second formats the app carried; there is now
// exactly one. UTC-parsed there, so a plain date string never shifts a day.
