 ...
 * carried from the play (A3, for the gate-readiness view), the play's why kept
 * as the citable reason (A4, so the knowledge survives acceptance), source
 * columns carrying the play id.
 */
